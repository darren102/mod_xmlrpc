...
muc_room_set_affiliation struct[{name, String}, {service, String},
 ...
 -- Messaging
send_message struct[{jid, String}, {subject, String}, {body, String}]       Integer
...
> xmlrpc:call("127.0.0.1", 4560, "/", {call, create_muc_room, [{struct, [{name, "SiteMembers"}, {service, "conference.xmpp.darren.dev.spawareurope.com"}, {server, "xmpp.darren.dev.spawareurope.com"}]}]}).
